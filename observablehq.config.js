...
export default {
  ...
  head: '<link rel="icon" href="media/filbeam-logo.png" type="image/png" sizes="32x32"><script defer data-domain="dashboard.filbeam.com" src="https://plausible.io/js/script.js"></script>',
